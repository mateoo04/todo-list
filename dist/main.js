...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,uBAAuB;EACvB,6BAA6B;AAC/B;;AAEA;EACE,wBAAwB;EACxB;;0DAEwC;AAC1C;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,SAAS;EACT,aAAa;EACb,gCAAgC;EAChC,oCAAoC;AACtC;;AAEA;EACE,qCAAqC;EACrC,WAAW;EACX,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,+BAA+B;EAC/B,gBAAgB;EAChB,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;;EAEE,uBAAuB;EACvB,SAAS;EACT,kBAAkB;EAClB,cAAc;EACd,WAAW;AACb;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;EACT,gBAAgB;AAClB;;AAEA;;EAEE,6BAA6B;AAC/B;;AAEA;EACE,gBAAgB;EAChB,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,YAAY;AACd;;AAEA;EACE,0BAA0B;EAC1B,yDAA2C;EAC3C,aAAa;AACf;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,WAAW;EACX,qCAAqC;EACrC,UAAU;EACV,SAAS;EACT,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,WAAW;EACX,cAAc;EACd,+BAA+B;AACjC;;AAEA;EACE,kBAAkB;EAClB,cAAc;EACd,0BAA0B;AAC5B;;AAEA;;;EAGE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,YAAY;AACd;;AAEA;;EAEE,mBAAmB;EACnB,SAAS;AACX;;AAEA;;;;;;;;EAQE,mBAAmB;EACnB,SAAS;EACT,iBAAiB;AACnB;;AAEA;;;;EAIE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;AAClB;;AAEA;;EAEE,gBAAgB;EAChB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;AACrB;;AAEA;EACE,qCAAqC;EACrC,gBAAgB;EAChB,WAAW;EACX,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;AAClB;;AAEA,YAAY;AACZ;EACE,2CAA2C;EAC3C,mBAAmB;EACnB,iBAAiB;EACjB,kBAAkB;AACpB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,6DAA6D;EAC7D,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,iCAAiC;AACnC;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,cAAc;AAChB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,SAAS;EACT,2CAA2C;EAC3C,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,4BAA4B;EAC5B,SAAS;EACT,2CAA2C;EAC3C,YAAY;AACd;;AAEA;;EAEE,UAAU;AACZ;;AAEA;EACE,8BAA8B;AAChC;;AAEA;EACE,8BAA8B;AAChC;;AAEA;EACE,8BAA8B;AAChC;;AAEA;EACE,yBAAyB;EACzB,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,WAAW;AACb;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA,iCAAiC;AACjC;;EAEE,WAAW;AACb;;AAEA;EACE,qCAAqC;EACrC,gBAAgB;EAChB,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,gBAAgB;EAChB,gBAAgB;EAChB,mBAAmB;AACrB","sourcesContent":[":root {\n  --accent-color: #ef6f6c;\n  --light-accent-color: #fcf3f2;\n}\n\n@font-face {\n  font-family: \"Playwrite\";\n  src:\n    url(\"./Playwrite.woff2\") format(\"woff2\"),\n    url(\"./Playwrite.woff\") format(\"woff\");\n}\n\n* {\n  font-family: Arial, Helvetica, sans-serif;\n}\n\nbody {\n  margin: 0;\n  display: grid;\n  grid-template-columns: 240px 1fr;\n  grid-template-rows: max(100vh, 100%);\n}\n\n.menu {\n  background-color: var(--accent-color);\n  color: #fff;\n  padding: 0px 20px;\n  font-size: 1.2em;\n}\n\nh1 {\n  font-family: \"Playwrite\", Arial;\n  font-size: 2.2em;\n  text-align: center;\n  padding-right: 12px;\n}\n\n.menu .all-tasks,\n.add-list-button {\n  background: transparent;\n  border: 0;\n  font-size: inherit;\n  padding: 5px 0;\n  color: #fff;\n}\n\n.add-list-button {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  margin-left: 8px;\n}\n\n.menu button:hover,\n.menu li:hover {\n  text-shadow: 1px 0px 1px #fff;\n}\n\n.plus-sign {\n  font-size: 1.4em;\n  font-weight: 600;\n}\n\n.your-lists {\n  margin-bottom: 0;\n  opacity: 0.8;\n}\n\n.menu ul {\n  padding-inline-start: 30px;\n  list-style-image: url(\"./chevron-icon.svg\");\n  margin-top: 0;\n}\n\n.menu li::marker {\n  font-size: 1.8em;\n}\n\n.task-list {\n  padding: 0px 30px;\n}\n\n.add-task {\n  position: fixed;\n  bottom: 20px;\n  right: 20px;\n  background-color: var(--accent-color);\n  outline: 0;\n  border: 0;\n  width: 64px;\n  height: 64px;\n  border-radius: 50%;\n  color: #fff;\n  font-size: 2em;\n  box-shadow: 1px 1px 1px #808080;\n}\n\nh2 {\n  padding: 20px 30px;\n  font-size: 2em;\n  color: var(--accent-color);\n}\n\nbutton,\ninput,\n.menu li {\n  cursor: pointer;\n}\n\nform {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  width: 270px;\n}\n\nform input,\ndialog {\n  border-radius: 16px;\n  border: 0;\n}\n\nform input,\ntextarea,\ninput[type=\"submit\"],\nform select,\n.close-dialog-button,\n.delete-task,\n.close-deletion-dialog-button,\n.close-edit-dialog-button {\n  border-radius: 12px;\n  border: 0;\n  padding: 6px 12px;\n}\n\nform input[type=\"text\"],\nform input[type=\"date\"],\nform select,\nform textarea {\n  background-color: #f5f5f5;\n}\n\nselect[name=\"priority\"] {\n  margin-left: 8px;\n}\n\nform legend,\n.task-details-header {\n  font-size: 1.4em;\n  font-weight: 600;\n  margin: 0 0 4px 0;\n}\n\nform label {\n  text-transform: uppercase;\n  font-size: 0.6em;\n  color: #827f7f;\n}\n\nlabel[for=\"priority\"] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\ninput[type=\"submit\"] {\n  background-color: var(--accent-color);\n  margin-top: 10px;\n  color: #fff;\n  font-weight: 700;\n}\n\n.close-dialog-button {\n  font-weight: 700;\n}\n\n/*Task item*/\n.task-item {\n  background-color: var(--light-accent-color);\n  border-radius: 20px;\n  padding: 4px 18px;\n  margin-bottom: 8px;\n}\n\n.task-item:hover {\n  cursor: pointer;\n}\n\n.on-hover-details {\n  padding-left: 30px;\n}\n\n.on-hover-details > p {\n  opacity: 0.7;\n}\n\n.basic-info {\n  display: grid;\n  grid-template-columns: min-content 1fr repeat(2, min-content);\n  align-items: center;\n  gap: 12px;\n}\n\ninput[type=\"checkbox\"] {\n  accent-color: var(--accent-color);\n}\n\n.task-info p:first-child {\n  font-weight: 700;\n}\n\n.task-info p {\n  margin: 3px 0;\n  color: #323232;\n}\n\n.task-due-date {\n  text-wrap: nowrap;\n}\n\n.details-button {\n  height: 26px;\n  width: 26px;\n  border: 0;\n  background-color: var(--light-accent-color);\n  opacity: 0.8;\n}\n\n.delete-task-button {\n  width: 20px;\n  height: 24px;\n  background-repeat: no-repeat;\n  border: 0;\n  background-color: var(--light-accent-color);\n  opacity: 0.8;\n}\n\n.details-button:hover,\n.delete-task-button:hover {\n  opacity: 1;\n}\n\n.low-priority {\n  border-left: 6px solid #ef6f6c;\n}\n\n.medium-priority {\n  border-left: 6px solid #ad4f4d;\n}\n\n.high-priority {\n  border-left: 6px solid #472221;\n}\n\noption[value=\"low\"] {\n  background-color: #ef6f6c;\n  color: #fff;\n}\n\noption[value=\"medium\"] {\n  background-color: #a34b49;\n  color: #fff;\n}\n\noption[value=\"high\"] {\n  background-color: #5f2c2b;\n  color: #fff;\n}\n\n.message-dialog button {\n  width: 100%;\n}\n\n.message-dialog p {\n  max-width: 300px;\n  text-align: center;\n}\n\n/*confirm deletion dialog button*/\n.delete-task,\n.close-deletion-dialog-button {\n  width: 100%;\n}\n\n.delete-task {\n  background-color: var(--accent-color);\n  font-weight: 700;\n  margin-bottom: 6px;\n  color: #fff;\n}\n\n.confirm-deletion-dialog p {\n  font-size: 1.2em;\n  margin-top: 20px;\n  margin-bottom: 30px;\n}\n"],"sourceRoot":""}]);
// Exports
...
function updateListsList(taskLists) {
...
class TaskList {
  ...
  constructor(title, isRetrieving = false) {
    ...
    if (isRetrieving === false) saveDataToLocalStorage(this);
  }
...
class Task {
  constructor(
    ...
    nonFormattedDueDate == ""
      ? (this.dueDate = "")
      : (this.dueDate = getDate(nonFormattedDueDate));
...
pubsub_js__WEBPACK_IMPORTED_MODULE_2___default().subscribe(NEW_LIST, (msg, newListTitle) => {
  if (
    validateTitle(newListTitle) &&
    TaskList.findByTitle(newListTitle) === undefined
  ) {
    new TaskList(newListTitle);
    requestListsListUpdate();
  } else {
    requestMessageDialog(
      "The name you entered is either not valid or is already in use."
    );
  }
});
...
pubsub_js__WEBPACK_IMPORTED_MODULE_2___default().subscribe(TASK_MODIFICATION, (msg, changeObject) => {
  ...
  for (const [key, value] of Object.entries(changeObject)) {
    ...
    if (key === "nonFormattedDueDate") {
      ...
      else taskForModification.dueDate = getDate(value);
    }
  }
...
pubsub_js__WEBPACK_IMPORTED_MODULE_2___default().subscribe(EDIT_TASK, (msg, selectedTask) => {
  ...
  (0,_dommanager_js__WEBPACK_IMPORTED_MODULE_1__.showEditTaskDialog)(
    task.id,
    task.title,
    task.nonFormattedDueDate,
    task.priority,
    task.note
  );
});
...
function generateId() {
  return (
    `${TaskList.getActiveList().title.toLowerCase().replaceAll(" ", "")}-` +
...
if (TaskList.findByTitle("My List") === undefined) {
  ...
  new Task(
    ...
    "2024-08-01",
    "medium",
    "Do a 10-minute foam rolling session to aid recovery."
  );
  new Task(
    "Strength Training",
    "Gym",
  ...
  new Task(
    "Take 30g of protein post-workout",
    "Gym",
    "2024-08-01",
    "low",
    "Focus on upper body exercises."
  ...
  new Task(
    "Check out more lower body workouts",
    "Gym",
    "2024-08-01",
    "medium",
    "Focus on upper body exercises."
